...
export default function ClubContainer({ club }: { club: clubType }) {
    ...
    return <TouchableOpacity style={{ width: "49%", height: 300, borderRadius: 10, marginBottom: 10, alignItems: "center", display: "flex", justifyContent: "space-between" }} className="bg-white" 
        onPress={()=> {
    ...
    >
        <View className="w-full">
            {
                isDefaultImage ?
                    <Image source={resourceController["default_image"]} style={{ width: "100%", height: 150, padding: 10, borderRadius: 7 }} /> :
                    <Image source={{ uri: club.image }} style={{ width: "100%", height: 150, padding: 10, borderRadius: 7 }} />
            }

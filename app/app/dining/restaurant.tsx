...
export default function RestaurantPage({ route }: { route: any }) {
  ...
  useEffect(() => {
    fetch(
      buildApiUrl("/dining/restaurantdetail", {
  ...
  function seeMenu() {
    if (restaurantData.isFDMealPlanner) {
      ...
      // Sorry
      router.push(
        `/dining/menu?restaurantCode=${restaurantCode}&restaurantName=${restaurantName}&restaurantID=${restaurantID}&restaurantIcon=${restaurantIcon}&bannerImage=${bannerImage}`,
      );
      ...
      >
        ...
        >
              ...
              >
                {chefs.length > 0 ? (
                  ...
                  <Text style={{ fontSize: 20, color: "#111" }}>
                    No visiting chefs currently scheduled.
                  </Text>
                )}
              </ScrollView>
            </>
          ) : null}
          {restaurantData.moreInfoLink != undefined ? (
            <View
              style={{
                width: "100%",
                flex: 1,
          ...
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
              style={{ fontWeight: "bold", color: "#F76902", fontSize: 16 }}
            >
              Sunday:
            </Text>{" "}
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Sunday"] ?? ""}
            </Text>
          </Text>
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
            ...
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Monday"] ?? ""}
            </Text>
          </Text>
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
            ...
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Tuesday"] ?? ""}
            </Text>
          </Text>
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
            ...
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Wednesday"] ?? ""}
            </Text>
          </Text>
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
            ...
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Thursday"] ?? ""}
            </Text>
          </Text>
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
            ...
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Friday"] ?? ""}
            </Text>
          </Text>
          <Text style={{ width: "100%", marginTop: 8 }}>
            <Text
            ...
            <Text style={{ fontSize: 14 }}>
              {restaurantData?.hoursOfOperations?.["Saturday"] ?? ""}
            </Text>
          </Text>
        </ScrollView>
      </View>

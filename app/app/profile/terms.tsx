...
// I tried to put this into a separate file but ran into issues 
const legalJibberJabber = `Terms and Conditions  
====================
...
For the purposes of these Terms and Conditions:
  ...
  * Application means the software program provided by the Organization downloaded
    by You on any electronic device, named RIT App
  ...
  * Organization (referred to as either "the Organization", "We", "Us" or "Our" in these
    Terms and Conditions) refers to Society of Software Engineers, 400
    Reynolds Dr, Rochester, NY 14623.
  ...
  * Terms and Conditions (also referred to as "Terms") means these Terms and
    ...
    agreement between You and the Organization regarding the Service. These Terms
  ...
  * You means the individual accessing or using the Service, or the organization,
...
agreement between You and the Organization. These Terms and Conditions set out the
...
You represent that you are over the age of 18. The Organization does not permit
...
The Organization has no control over, and assumes no responsibility for, the
content, privacy policies, or practices of any third-party websites or
services. You further acknowledge and agree that the Organization shall not be
...
Media Service is not owned or controlled by the Organization, and the Organization does
not endorse or assume responsibility for any Third-Party Social Media Service.

You acknowledge and agree that the Organization shall not be responsible or liable,
...
Organization and any of its suppliers under any provision of these Terms and Your
exclusive remedy for all of the foregoing shall be limited to the amount
actually paid by You through the Service or 100 USD if You haven't purchased
anything through the Service.

To the maximum extent permitted by applicable law, in no event shall the
Organization or its suppliers be liable for any special, incidental, indirect, or
...
provision of these Terms), even if the Organization or any supplier has been
...
under applicable law, the Organization, on its own behalf and on behalf of its
...
usage or trade practice. Without limitation to the foregoing, the Organization
...
Without limiting the foregoing, neither the Organization nor any of the organization's
...
of the Organization are free of viruses, scripts, trojan horses, worms, malware,
...
to resolve the dispute informally by contacting the Organization.
...
us:
  ...
  * By visiting this page on our website: <https://sse.rit.edu/>
`;
...
export default function terms() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, alignItems: "center" }}>
      ...
      <ScrollView contentContainerStyle={{width: Dimensions.get("window").width*.85}}>
